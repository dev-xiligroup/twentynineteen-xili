...
function twentynineteen_xili_customize_register( $wp_customize ) {
	$wp_customize->add_section( 'texts_section' , array(
					'title'       => __( 'Other texts section', 'twentynineteen' ),
					'priority'    => 421
	));

	$wp_customize->add_setting( 'copyright', array(
		'sanitize_callback' => 'twentynineteenxili_sanitize_text',
		'default' => __('My company','twentynineteen'),
		'transport' => 'postMessage',
		)
	);

	$wp_customize->add_control( 'copyright', array(
				'label'    => __( 'Your copyright (footer)', 'twentynineteen' ),
...
add_action( 'customize_register', 'twentynineteen_xili_customize_register', 12 ); // after parent
